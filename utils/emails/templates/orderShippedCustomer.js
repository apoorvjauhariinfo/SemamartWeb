...
const orderShippedCustomerTemplate = ({
  ...
  const bodyHtml = `
    ...
    <p style="margin: 0 0 24px; font-size: 16px; color: #2a2a2e; line-height: 1.6;">
      ...
      Great news! Your order has been <strong>shipped</strong> and is making its way to you. 
    ...
    <p style="margin: 32px 0 0; font-size: 14px; color: #9ca3af; line-height: 1.5;">
      Thank you for choosing <strong>Semamart</strong>. If you have any questions about your delivery, 
