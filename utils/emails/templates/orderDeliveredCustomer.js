// utils/emails/templates/orderDeliveredTemplate.js
...
const orderDeliveredCustomerTemplate = ({
  ...
  const bodyHtml = `
    ...
    <p style="margin: 0 0 24px; font-size: 16px; color: #2a2a2e; line-height: 1.6;">
      ...
      Great news! We’ve received confirmation that your order has been 
      <span style="color: #61ceb6; font-weight: 600;">successfully delivered</span>. 
          ...
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
              <td style="padding-bottom: 8px;">
                <p style="margin: 0; font-size: 13px; text-transform: uppercase; letter-spacing: 0.05em; color: #6b7280; font-weight: 600;">
                  Order ID
                </p>
    ...
    <p style="margin: 32px 0 0; font-size: 14px; color: #9ca3af; line-height: 1.5;">
      Thank you for choosing <strong>Semamart</strong>. If you have any questions or feedback about your delivery, 
      feel free to <a href="${frontendUrl}/support" style="color: #6EC1E5; text-decoration: underline;">contact our support team</a>.
    </p>
  `;

  return baseLayout({
    title: "Order Delivered | Semamart",
    preheader: "Your Semamart order #" + orderId + " has been delivered.",
    bodyHtml,
  });
};

module.exports = orderDeliveredCustomerTemplate;